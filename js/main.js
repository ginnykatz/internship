...
var lsco = L.geoJson.ajax('assets/data/lsco.geojson', {
    color: 'red',
    weight: 2,
    opacity: 0.3,
    onEachFeature: onEachFeature
...
//OSU 44.565890, -123.278968
var scenes = {
    landing: {lat: 44.628319, lng: -124.062425, zoom: 13, name: 'Home'},
    intro: {lat: 44.628319, lng: -124.062425, zoom: 10, name: 'Intro', layers: ['lsco','lincoln_county', 'basemap']},
    scope: {lat: 44.628319, lng: -124.062425, zoom: 7, name: 'Scope of Service'},
    prep: {lat: 44.628319, lng: -124.062425, zoom: 10, name: 'Preparedness Priorities' , layers:['prep','basemap']},
    events: {lat: 44.636324, lng:-124.054765, zoom: 9, name: 'Training Events', layers: ['events','basemap']},
    courses: {lat: 44.628319, lng: -124.062425, zoom: 7, name: 'Applicable Courses'},
    core: {lat: 44.565890, lng: -123.278968, zoom: 15, name: 'Core Competencies', layers: ['basemap']},
    challenges: {lat: 44.628319, lng: -124.062425, zoom: 13, name: 'Discussion', layers: ['basemap']},
    next: {lat: 44.628319, lng: -124.062425, zoom: 13, name: 'Next'},
    end: {lat: 44.565890, lng: -123.278968, zoom: 13, name: 'The End',
}};
