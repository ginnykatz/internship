...
(function ($) {
    ...
    $.fn.storymap = function (options) {
        ...
        var makeStoryMap = function (element, scenes, layers) {
            ...
            if (settings.legend) {
                $(".storymap").append("<div class='viewing storymap-legend' />")
            }

            if (settings.scrolldown) {
                $(".storymap").append("<div class='zoomIn infinite fas fa-angle-down storymap-scroll-down' />")
            }
            ...
            if (settings.loader) {
                $(".storymap").append("<div class='fas fa-sync-alt storymap-loader' />")
            ...
            $(".storymap-map .leaflet-control-attribution")
                ...
                .html("<a href='https://github.com/jakobzhao/storymap'><img src='../assets/img/logo.png' width='18px' target='_blank' > storymap.js </a>");
            ...
            if (settings.navwidget) {
                $.each(sections, function (key, element) {
                    ...
                    if (key === 0) {
                        $(".storymap-navwidget").append('<li><a class="fas fa-home" data-toggle="tooltip" title="' + sceneName + '" href="' + scrollScript + '" ></a></li>');
                    } else {
                        $(".storymap-navwidget").append('<li><a class="fas fa-circle little" data-toggle="tooltip" title="' + sceneName + '" href="' + scrollScript + '" ></a></li>');
                    }
                });
